About goodtables-pandas-py-feedstock
====================================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/goodtables-pandas-py-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11686&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/goodtables-pandas-py-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `goodtables-pandas-py` can be installed with `conda`:
...
```
mamba install goodtables-pandas-py
```

It is possible to list all of the versions of `goodtables-pandas-py` available on your platform with `conda`:
...
```
mamba search goodtables-pandas-py --channel conda-forge
```
...
mamba repoquery search goodtables-pandas-py --channel conda-forge

# List packages depending on `goodtables-pandas-py`:
mamba repoquery whoneeds goodtables-pandas-py --channel conda-forge

# List dependencies of `goodtables-pandas-py`:
mamba repoquery depends goodtables-pandas-py --channel conda-forge
```
